        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a class="btn btn-danger" href="{{ route('admin.gym-management.members.create') }}"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;&nbsp;Add</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <select name="search_column" class="form-select mb-3">
                                ...
                                <!--<option value="" {{ request('search_column') == '' ? 'selected' : '' }}>Membership Name</option>-->
                                <!--<option value="" {{ request('search_column') == '' ? 'selected' : '' }}>Membership Expiration Date</option>-->
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="action-button">
                                                            <!--<form action="{{ route('admin.gym-management.members.delete') }}" method="POST" style="display: inline;">-->
                                                            <!--    @csrf-->
                                                            <!--    @method('DELETE')-->
