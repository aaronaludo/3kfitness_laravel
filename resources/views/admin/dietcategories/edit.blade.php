...
@section('title', 'Edit Diet Categories')

@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                <div><h2 class="title">Edit Diet Categories</h1></div>
            </div>
            <div class="col-lg-12">
                <div class="box">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ route('admin.diet-categories.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="dietCategoryForm">
                                @csrf
                                @METHOD('PUT')
                                @if ($errors->any())
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="text" class="form-control" id="protein" name="protein" value="{{ $data->protein }}" required/>
                                    </div>
                                </div>   
                                <div class="mb-3 row">
                                    <label for="fat" class="col-sm-12 col-lg-2 col-form-label">Fat: </label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="text" class="form-control" id="fat" name="fat" value="{{ $data->fat }}" required/>
                                    </div>
                                </div>   
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <textarea class="form-control" id="ingredients" name="ingredients" rows="7" required>{{ $data->ingredients }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="recipe_description" class="col-sm-12 col-lg-2 col-form-label">Recipe Description: </label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <textarea class="form-control" id="recipe_description" name="recipe_description" rows="7" required>{{ $data->recipe_description }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
